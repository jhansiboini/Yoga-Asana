...
asanasDetails = {
    'downward-facing-dog': {
        ...
        'asanaImgPath': '../static/img/down_dog.png',
        'METs':2.5
    },
    'goddess': {
        'title': "Goddess",
        ...
        'asanaImgPath':'../static/img/goddess.png',
        'METs':2.5
    },
    'plank': {
        'title': "Plank",
        ...
        'asanaImgPath':'../static/img/plank.png',
        'METs':4.0
    },
    'tree': {
        'title': "Tree",
        ...
        'asanaImgPath': '../static/img/tree.png',
        'METs':2.5
    },
    'warrior-2': {
        'title': "Warrior 2",
        ...
        'asanaImgPath': '../static/img/warrior_2.png',
        'METs':4.0
    }
}
asanaMETs = {
...
def tutorial(asana):
    ...
    return render_template('tutorial.html', selected_asana=selected_asana, asanaImg_path = asanasDetails[asana]['asanaImgPath'])
